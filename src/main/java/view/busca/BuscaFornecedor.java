...
public class BuscaFornecedor extends javax.swing.JDialog {
    ...
    /**
     * Creates new form BuscaFornecedorD
     */
    ...
    private void initComponents() {
        ...
        jCBFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "id", "status", "nome", "cnpj", "razaosocial", "complemento" }));
        ...
        jTableDados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Status", "Nome", "CNPJ", "Razão Social", "Inscrição Estadual", "Complemento", "Logradouro", "Bairro", "Cidade", "CEP", "Email", "Telefone1", "Telefone2"
            }
        ));
